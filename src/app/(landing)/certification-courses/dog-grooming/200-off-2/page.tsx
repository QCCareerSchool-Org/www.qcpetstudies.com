...
const DogGrooming200Off2Page: PageComponent = async props => {
  ...
  const [ dgPrice, dePrice ] = await Promise.all([
    fetchPrice([ 'dg' ], countryCode, provinceCode, { promoCode: 'DG200', school: 'QC Pet Studies' }),
    fetchPrice([ 'de' ], countryCode, provinceCode, { promoCode: 'DG200', school: 'QC Pet Studies' }),
  ]);
