...
const DogGrooming400OffPage: PageComponent = async props => {
  ...
  const [ dgPrice, dePrice ] = await Promise.all([
    fetchPrice([ 'dg' ], countryCode, provinceCode, { promoCode: 'DG400', school: 'QC Pet Studies' }),
    fetchPrice([ 'de' ], countryCode, provinceCode, { promoCode: 'DG400', school: 'QC Pet Studies' }),
  ]);
