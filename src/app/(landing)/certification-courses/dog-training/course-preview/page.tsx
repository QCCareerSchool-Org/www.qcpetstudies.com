  ...
  return (
    <>
      <section className="bg-dark">
        <BackgroundImage src={GoldenRetrieverComputerBackground} priority />
            ...
            <div className="col-12 col-md-6">
              <div className="card bg-lighter border-lighter">
                <div className="card-body">
                  ...
                  <p className="card-text"><strong>New!</strong> Take your training to the next level with our <strong>Optional Externship Track</strong>—get additional real-world, hands-on experience working side-by-side with a professional dog trainer.</p>
                </div>
              </div>
            </div>
          </div>
