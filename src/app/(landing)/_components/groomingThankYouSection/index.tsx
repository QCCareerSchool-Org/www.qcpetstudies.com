        ...
        <div className="row g-0">
          <div className="col-12 col-md-7 col-lg-6 col-xl-5 order-lg-first text-left">
            <div style={{ margin: '3rem 0' }}>
              ...
              <p className="lead mb-4">We've just sent your course preview to {emailAddress ? <strong>{emailAddress}</strong> : 'your inbox'}. Be sure to check your junk or spam folder so you don't miss any important updates.</p>
