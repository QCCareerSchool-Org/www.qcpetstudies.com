  ...
  return <>
    ...
    <section id="top" className="bg-dark">
      <Image
        ...
        placeholder="blur"
        alt="groomer trimming a dog's hair"
        priority
        fill
        sizes="100vw"
