...
export const DogGroomingBase: FC<Props> = ({ dgPrice, dePrice, enrollPath, courseCodes }) => {
  ...
  return (
    <>
      <div>
        <Suspense><CourseSchema courseID="dog-grooming" courseCode={courseCodes[0] as CourseCode} /></Suspense>
            ...
            <div className="row mb-4">
              <div className="col-12 col-md-8 col-lg-6 offset-lg-1">
                ...
                <div className="d-flex justify-content-center justify-content-md-start">
                  <Link href={`https://enroll.qcpetstudies.com${enrollPath}?c=dg`}><button className="btn btn-primary me-3">Enroll Now</button></Link>
