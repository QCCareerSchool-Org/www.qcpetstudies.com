...
const DogGrooming500OffPage: PageComponent = async () => {
  ...
  const priceQuery: PriceQuery = { countryCode, provinceCode: provinceCode ?? undefined, courses: courseCodes, options: { school: 'QC Pet Studies', promoCode: 'DG500' } };
  ...
  return (
    <>
      ...
      <DogGroomingBase price={price} enrollPath="/grooming-500-off" courseCodes={courseCodes} />;
    </>
  );
};
