...
export const Client: FC<Props> = ({ dgPrice, dePrice }) => {
  ...
  return (
    <>
        ...
        <div className="container text-center">
          ...
          <div className="row justify-content-center g-5 mb-5">
            <div className="col-12 col-md-8 col-lg-6">
              <h3 className="mb-3">Dog Grooming Online Track</h3>
            ...
            <div className="col-12 col-md-8 col-lg-6">
              <h3 className="mb-3"><span className="text-danger">NEW:</span> Dog Grooming Externship Track</h3>
      ...
      <PriceSection className="bg-light" dgPrice={dgPrice} dePrice={dePrice} onPopupLinkClick={handlePopupLinkClick} />
    </>
  );
};
