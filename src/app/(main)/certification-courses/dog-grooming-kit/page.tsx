      ...
      <div className="container text-center">
        <div className="row justify-content-center">
          ...
          <div className="col-12 col-md-10 col-lg-8">
            ...
            <p className="lead">Your kit includes professional-grade grooming scissors, brushes, combs, and nail clippers. This kit will go a long way not only to help you complete your online course but also to enter the industry as a fully equipped dog grooming professional!</p>
      ...
      <div className="container">
        ...
        <div className="row justify-content-center mb-4">
          <div className="col-12 col-sm-10 col-md-6 mb-4 mb-md-0 d-flex">
            <div className="card">
              <Image src={ToolsStarterSetImage} className="card-img-top" alt="dog gooming starter set" style={{ maxWidth: '100%', height: 'auto' }} />
              <div className="card-body">
                <h3 className="card-text">Grooming Tools Starter Set</h3>
                <p className="card-text">Some routine tools of the trade that all groomers need are provided in this starter kit. You'll learn to expertly use every one of these tools in your course, and you'll probably use them every day throughout your dog grooming career! This 11-piece set includes:</p>
                <ul>
