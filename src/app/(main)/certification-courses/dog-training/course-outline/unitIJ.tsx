  ...
  return (
    <div className="row">
      <div className="col-12 col-lg-6 col-xl-7">
        ...
        <p><strong>1. Submit Your Externship Application</strong></p>
        ...
        <p><strong>2. Placement Matching</strong></p>
        ...
        <p><strong>3. Receive Your Placement & Sign Documentation</strong></p>
        ...
        <p><strong>4. Begin Your Externship</strong></p>
        ...
        <p><strong>5. Track Your Hours & Get Evaluated</strong></p>
        ...
        <p><strong>6. Receive Your Certificate of Completion</strong></p>
