        ...
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-12 col-lg-10">
              ...
              {countryCode === 'CA' && (
                <>
                  <h3 className={styles.question}>Can I claim my course tuition on my taxes?</h3>
              ...
              <h3 className={styles.question}>Is QC Pet Studies an accredited online school?</h3>
              ...
              <h3 className={styles.question}>What type of payment plans does QC offer?</h3>
              ...
              <h3 className={styles.question}>How does the money back guarantee work?</h3>
              ...
              <h3 className={styles.question}>What if I miss a tuition payment?</h3>
              ...
              <h3 className={styles.question}>Are there any technology requirements to complete my online courses with QC?</h3>
              ...
              <h3 className={styles.question}>What do I do if I get stuck on a course assignment?</h3>
              ...
              <h3 className={styles.question}>How will QC help me start my career once I've finished the online course?</h3>
              ...
              <h3 className={styles.question}>I'm not interested in starting a business. Do I still have to complete the business training in my online course?</h3>
        ...
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-12 col-lg-10">
              ...
              <h3 className={styles.question}>Is it possible to learn dog grooming online?</h3>
              ...
              <p>QC's Student Support Specialists are also available to answer your questions before, during, and after your online dog grooming course! <Link href="/contact-us" className="link-primary">Contact QC Pet Studies</Link> by phone, email, or Live Chat.</p>

              <h3 className={styles.question}>Do I need prior training or experience as a dog groomer before taking this course?</h3>
              ...
              <h3 className={styles.question}>Will I need to purchase anything else to complete the dog groomer course?</h3>
              ...
              <h3 className={styles.question}>How long will it take to complete my online dog grooming class?</h3>
              ...
              <h3 className={styles.question}>How exactly do the hands-on grooming assignments and practicum dog grooming units work?</h3>
              ...
              <h3 className={styles.question}>Do I need a state or provincial dog grooming license to work in the industry?</h3>
              ...
              <h3 className={styles.question}>Will I be able to receive discounts toward dog grooming tools and equipment as a student or graduate?</h3>
              <p>Yes! QC Pet Studies students and graduates are eligible to receive discounts from a variety of pet retailers. Find a <Link href="/about/student-discounts" className="link-primary">full list of preferred dog grooming suppliers here</Link>.</p>

              <h3 className={styles.question}>How much can you earn as a professional dog groomer?</h3>
        ...
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-12 col-lg-10">
              ...
              <h3 className={styles.question}>Is it possible to learn to become a professional dog trainer online?</h3>
              ...
              <p>QC's Student Support Specialists are also available to answer your questions before, during, and after your online dog training course! <Link href="/contact-us" className="link-primary">Contact QC Pet Studies</Link> by phone, email, or Live Chat.</p>

              <h3 className={styles.question}>Do I need prior training or experience as a dog trainer before taking this course?</h3>
              ...
              <h3 className={styles.question}>Will I need to purchase anything else to complete the dog training course?</h3>
              ...
              <h3 className={styles.question}>How long will it take to complete my online dog training class?</h3>
              ...
              <h3 className={styles.question}>What methods do you teach as part of the dog training class?</h3>
              ...
              <h3 className={styles.question}>Do I need a state or provincial dog training license to work in the industry?</h3>
              ...
              <p>The online dog training course provided by QC was developed to prepare students for the CPDT-KA exam. You can learn more about obtaining your CPDT certification <a href="https://www.ccpdt.org/certification/dog-trainer-certification/about-the-examination/" target="_blank" rel="noopener noreferrer" className="link-primary">here</a>.</p>

              <h3 className={styles.question}>Will I be able to receive discounts toward dog training tools and equipment as a student or graduate?</h3>
              <p>Yes! QC Pet Studies students and graduates are eligible to receive discounts from a variety of pet retailers. Find a <Link href="/about/student-discounts" className="link-primary">full list of preferred suppliers here</Link>.</p>

              <h3 className={styles.question}>How much can you earn as a professional dog trainer?</h3>
