      ...
      <div className="container-fluid text-center">
        <div className="row">
          <div className="col-12 col-lg-6" style={{ position: 'relative' }}>
            <Image src={WomanUsingLaptopImage} placeholder="blur" alt="woman using a laptop with a Chihuahua on her lap" fill sizes="100vw" style={{ objectFit: 'cover', objectPosition: 'center' }} />
          </div>
      ...
      <div className="container text-center text-lg-start">
        <div className="row justify-content-center align-items-center">
          ...
          <div className="col-12 col-sm-10 col-md-8 col-lg-6 col-xl-4 col-xxl-3">
            <Image src={CertifiedExpertImage} alt="collage of dogs" sizes="100vw" style={{ width: '100%', height: 'auto' }} />
          </div>
        </div>
      </div>
    </section> */}
      ...
      <div className="container text-center">
        ...
        <div className="row justify-content-center">
          ...
          <div className="col-12 col-lg-10">
            ...
            <Image src={LineOfDogsImage} alt="a line of nine dogs standing side to side" sizes="100vw" style={{ width: '100%', height: 'auto' }} />
          </div>
        </div>
      </div>
    </section> */}
