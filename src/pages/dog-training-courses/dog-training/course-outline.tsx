      ...
      <div className="container">
        ...
        <div className="row justify-content-center mb-3">
          <div className="col-12 col-lg-6">
            <div className="row mb-2">
              <p className="col-lg-4 col-6"><BsPencilSquare />&nbsp; 5 (1 hour)</p>
              <p className="col-lg-4 col-6"><BsBookHalf />&nbsp; 1-2 hours</p>
              <p className="col-lg-4 col-6"><BsPlayCircle />&nbsp; 3 Videos (15 minutes)</p>
            </div>
          ...
          <div className="col-12 col-lg-6">
            <Image src={UnitAImage} alt="Dog running" height="230" width="400" />
          </div>
        </div>
        ...
        <div className="row justify-content-center mb-3">
          <div className="col-12 col-lg-6">
            <div className="row mb-2">
              <p className="col-lg-4 col-6"><BsPencilSquare />&nbsp; 5 (1 hour)</p>
              <p className="col-lg-4 col-6"><BsBookHalf />&nbsp; 2 hours</p>
              <p className="col-lg-4 col-6"><BsPlayCircle />&nbsp; 3 Videos (25 minutes)</p>
            </div>
          ...
          <div className="col-12 col-lg-6">
            <Image src={UnitBImage} alt="Man walking the dog" height="225" width="400" />
          </div>
        </div>
        ...
        <div className="row justify-content-center mb-3">
          <div className="col-12 col-lg-6">
            <div className="row mb-2">
              <p className="col-lg-4 col-6"><BsPencilSquare />&nbsp; 5 (x hours)</p>
              <p className="col-lg-4 col-6"><BsBookHalf />&nbsp; 1 hours</p>
              <p className="col-lg-4 col-6"><BsPlayCircle />&nbsp; 2 Videos (25 minutes)</p>
            </div>
          ...
          <div className="col-12 col-lg-6">
            <Image src={UnitCImage} alt="Dog resting on mat/bed" height="225" width="400" />
          </div>
        </div>
        ...
        <div className="row justify-content-center mb-3">
          ...
          <div className="col-12 col-lg-6">
            <Image src={UnitDImage} alt="Dog looking at person" height="225" width="400" />
          </div>
        </div>
        ...
        <div className="row justify-content-center mb-3">
          ...
          <div className="col-12 col-lg-6">
            <Image src={UnitEImage} alt="Dog playing" height="225" width="400" />
          </div>
        </div>

        <Accordion defaultActiveKey="0" className="mb-5">
          <AccordionToggle title="Full Unit Overview" eventKey="4" variant="primary" />
        ...
        <div className="row justify-content-center mb-3">
          ...
          <div className="col-12 col-lg-6">
            <Image src={UnitFImage} alt="Dog growling on other dog" height="225" width="400" />
          </div>
        </div>

        <Accordion defaultActiveKey="0" className="mb-5">
          <AccordionToggle title="Full Unit Overview" eventKey="5" variant="primary" />
        ...
        <div className="row justify-content-center mb-3">
          ...
          <div className="col-12 col-lg-6">
            <Image src={UnitGImage} alt="Dog standing with person" height="225" width="400" />
          </div>
        </div>

        <Accordion defaultActiveKey="0" className="mb-5">
          <AccordionToggle title="Full Unit Overview" eventKey="6" variant="primary" />
        ...
        <div className="row justify-content-center mb-3">
          ...
          <div className="col-12 col-lg-6">
            <Image src={UnitHImage} alt="Dog handshaking women" height="225" width="400" />
          </div>
        </div>

        <Accordion defaultActiveKey="0" className="mb-5">
          <AccordionToggle title="Full Unit Overview" eventKey="7" variant="primary" />
