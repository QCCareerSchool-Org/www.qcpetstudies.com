          ...
          <div className="row align-items-stretch justify-content-center">
            <div className="col-10 col-lg-6 col-xxl-4 d-flex align-items-stretch mb-5 mb-lg-4 mb-xxl-0">
              <CertificationCard show={lg}>
                ...
                <Link href="/certification-courses/dog-training"><button className="btn btn-secondary">View Course</button></Link>
              </CertificationCard>
            </div>
            <div className="col-10 col-lg-6 col-xxl-4 d-flex align-items-stretch mb-5 mb-lg-4 mb-xxl-0">
              <CertificationCard show={lg}>
                ...
                <Link href="/certification-courses/dog-grooming"><button className="btn btn-secondary">View Course</button></Link>
              </CertificationCard>
            </div>
            <div className="col-10 col-lg-6 col-xxl-4 d-flex align-items-stretch">
              <CertificationCard show={lg}>
                ...
                <Link href="/certification-courses/dog-daycare"><button className="btn btn-secondary">View Course</button></Link>
              </CertificationCard>
            </div>
          </div>
        </div>
