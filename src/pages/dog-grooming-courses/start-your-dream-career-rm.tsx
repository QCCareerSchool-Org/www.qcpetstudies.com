        ...
        <div className="container text-center">
          ...
          <div className="row justify-content-center">
            <div className="col-12 col-lg-9">
              ...
              <p>People love their pets – that&apos;s why dog grooming is a rapidly growing industry across the globe. QC&apos;s Dog Grooming course helps you turn your love of animals into a creative, flexible, and fulfilling career.</p>
            </div>
          </div>
        </div>
      </section>
