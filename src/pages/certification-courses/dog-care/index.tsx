...
const DogCarePage: NextPageWithLayout<Props> = ({ price }) => {
  ...
  return (
    <>
      <SEO
        title="Dog Care Course"
        description="Become a certified dog care professional with interactive online training!"
        canonical="/certification-courses/dog-care"
      />

      <section id="top" className="bg-dark">
        <Image src={DogCareBackground} layout="fill" objectFit="cover" objectPosition="right" placeholder="blur" alt="Jack Russel Terrier in a handbag" priority />
        ...
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-12 col-lg-10 mb-4 text-center">
              ...
              <p className="lead">The Dog Daycare course is split into four main parts, each with individual training units designed to build your skills and confidence as a dog daycare provider.</p>
            </div>
          </div>
          <Accordion defaultActiveKey="0">
            <AccordionToggle title="Part 1: Introductory Units" eventKey="0" />
            <AccordionSection eventKey="0">
              ...
              {/* <p className="mb-0"><Link href="/certification-courses/dog-care/course-outline"><a className="link-primary">View a more-detailed course syllabus</a></Link></p> */}
            </AccordionSection>
