      ...
      <div className="container text-center">
        ...
        <div className="row justify-content-center mb-5">
          <div className="col-12 col-sm-8 col-lg-4 mb-4 mb-lg-0 d-flex">
            <div className="card">
              <Image src={VirtualClassroom} className="card-img-top" alt="smiling lady at a laptop" />
          ...
          <div className="col-12 col-sm-8 col-lg-4 mb-4 mb-lg-0 d-flex">
            <div className="card">
              <Image src={StudentGrad} className="card-img-top" alt="smiling man crouched down, petting a dog" />
              <div className="card-body">
          ...
          <div className="col-12 col-sm-8 col-lg-4 d-flex">
            <div className="card">
              <Image src={LearningInClassOnline} className="card-img-top" alt="dog resting his chin on a laptop" />
              <div className="card-body">
        ...
        <div className="row justify-content-center">
          <div className="col-12 text-start">
            ...
            <ul>
              ...
              <li><Link href="/certification-courses/dog-grooming/course-outline"><a className="link-primary">Dog Grooming Course Outline</a></Link></li>
              <li><Link href="/certification-courses/dog-training/course-outline"><a className="link-primary">Dog Training Course Outline</a></Link></li>
              <li><Link href="/certification-courses/dog-daycare/course-outline"><a className="link-primary">Dog Daycare Course Outline</a></Link></li>
