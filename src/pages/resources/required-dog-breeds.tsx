  ...
  return (
    <>
      ...
      <section id="top" className="bg-dark">
        <Image src={RequiredDogBreedsBackground} layout="fill" objectFit="cover" objectPosition="center" placeholder="blur" alt="dog in a towel after a bath" priority />
          ...
          <div className="row align-items-center">
            {lgOrGreater && (
              <div className="col-12 col-lg-3 offset-lg-1">
                <Image src={RequiredDogBreedImage} layout="responsive" alt="assignment" />
              </div>
            )}
          ...
          <div className="row align-items-stretch">
            ...
            <div className="col-12 col-md-6 mb-g d-flex align-items-center">
              <div className="card-body text-center">
                <div className="mb-2">
                  <Image src={IconFirstAidLogo as StaticImageData} width={iconSize} height={iconSize} alt="first aid" />
                </div>
        ...
        <div className="container">
          ...
          <div className="row align-items-center">
            <div className="col-12 col-sm-10 offset-1 col-md-6 offset-md-0 mb-4">
              <Image src={PracticumImage1} layout="responsive" alt="Dog lying down" />
            </div>
            ...
            <div className="col-12 col-sm-10 offset-1 col-md-6 offset-md-0 mb-4">
              <Image src={PracticumImage2} layout="responsive" alt="Dog lying down" />
            </div>
            <div className="col-12 col-md-6 text-center text-md-start mb-4">
            ...
            <div className="col-12 col-sm-10 offset-1 col-md-6 offset-md-0 mb-4">
              <Image src={PracticumImage3} layout="responsive" alt="Dog lying down" />
            </div>
            <div className="col-12 col-md-6 text-center text-md-start mb-4">
