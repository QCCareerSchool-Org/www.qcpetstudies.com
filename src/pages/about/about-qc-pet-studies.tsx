  ...
  return (
    <DefaultLayout>
      <SEO
        ...
        description="QC Pet Studies has been offering quality distance education for over 35 years!"
            ...
            <div className="col-12 col-lg-5 mb-4 d-flex">
              <div className="card">
                <div className="card-body">
                  ...
                  <p className="card-text">Try your course risk-free for 21 days. This gives you time to properly evaluate whether the course is right for you. If you decide it s not a good fit, simply contact QC to arrange a return of your course materials for a refund. It&apos;s that easy!</p>
            ...
            <div className="col-12 col-lg-10 mb-4">
              ...
              <CoreValue
                ...
                right={(
                  <>
                    <h3>Quality</h3>
                    <p>QC offers the highest quality course materials and student services available. From lesson texts to video tutorials to tools of the trade, you&apos;ll see quality in every aspect of your course.</p>
                  </>
                )}
              />
              <CoreValue
                ...
                right={(
                  <>
                    ...
                    <p>Student Support Specialists are here to answer any questions you have about the course, the pet care industry or your career. We take pride in providing you with unparalleled service before and during your course. and even after you graduate.</p>
                  </>
                )}
              />
              <CoreValue
              ...
              <CoreValue
                ...
                right={(
                  <>
                    ...
                    <p>At QC Pet Studies, our goal is to see every student succeed. That&apos;s why we develop and maintain relationships with each and every dog grooming and dog training student throughout their course and after graduation, giving students a superior learning experience.</p>
                  </>
                )}
              />
            </div>
