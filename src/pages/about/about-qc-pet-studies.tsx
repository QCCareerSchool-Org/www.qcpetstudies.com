  ...
  return (
    <DefaultLayout>
      ...
      <section id="firstSection" className="bg-dark">
        <Image src={QcBackground} layout="fill" objectFit="cover" objectPosition="center" alt="happy dog panting" />
          ...
          <div className="row justify-content-center">
            <div className="col-12 col-lg-10">
              <div className="d-flex flex-column flex-md-row justify-content-start align-items-center mb-4">
                ...
                <p className="lead mb-0">We&apos;re an online, international school that&apos;s been offering distance education courses since 1984, and in this time weve mastered the art of delivering quality course content online.</p>
              </div>
            ...
            <div className="col-12 col-lg-5 mb-4 d-flex">
              <div className="card">
                <div className="card-body">
                  ...
                  <p className="card-text">This course will pay for itself within two years. That&apos;s a promise. If after two years of receiving your certificate of completion, you haven t earned the equivalent of your tuition fees in dog grooming fees or salary, your dog grooming course tuition will be refunded in full.</p>
                  <p className="card-text">All you have to do is provide proof that you ve made a reasonable effort to find work as a dog groomer.</p>
                </div>
              </div>
            </div>
            <div className="col-12 col-lg-10">
