            ...
            <div className="col-12 col-lg-5 mb-4 d-flex">
              <div className="card">
                <div className="card-body">
                  ...
                  <p className="mb-0">Your online course will pay for itself within two years, that&apos;s a promise.</p>
                  <p className="mb-0">That&apos;s right.  If after two years of receiving your certificate of completion, you haven&apos;t earned the equivalent of your tuition fees in your professional salary, your course tuition will be refunded in full.</p>
                  <p className="mb-0">All you have to do is provide proof that you&apos;ve made a reasonable effort to find work as a dog groomer or dog trainer.</p>
                  <p className="mb-0">Note: This guarantee is only valid for graduates of the online dog grooming or online dog training courses.</p>
                </div>
              </div>
            </div>
            <div className="col-12 col-lg-10">
              <p className="alert alert-primary mb-0">Questions? <Link href="/contact-us"><a className="alert-link">Contact Us</a></Link></p>
            </div>
          </div>
        </div>
      </section>
