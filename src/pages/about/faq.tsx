        ...
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-12 col-lg-10">
              ...
              <Accordion>
                <QuestionAnswer question="Is QC Pet Studies an accredited online school?" index={index.current++}>
                ...
                <QuestionAnswer question="What type of payment plans does QC offer?" index={index.current++}>
                ...
                <QuestionAnswer question="What do I do if I get stuck on a course assignment?" index={index.current++}>
                ...
                <QuestionAnswer question="How will QC help me start my career once I’ve finished the online course?" index={index.current++}>
                ...
                <QuestionAnswer question="I'm not interested in starting a business. Do I still have to complete the business training in my online course?" index={index.current++}>
        ...
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-12 col-lg-10">
              ...
              <QuestionAnswer question="Is it possible to learn dog grooming online?" index={index.current++}>
              ...
              <QuestionAnswer question="Do I need prior training or experience as a dog groomer before taking this course?" index={index.current++}>
              ...
              <QuestionAnswer question="Will I need to purchase anything else to complete the dog groomer course?" index={index.current++}>
              ...
              <QuestionAnswer question="How long will it take to complete my online dog grooming class?" index={index.current++}>
              ...
              <QuestionAnswer question="How exactly do the hands-on grooming assignments and practicum dog grooming units work?" index={index.current++}>
              ...
              <QuestionAnswer question="Do I need a state or provincial dog grooming license to work in the industry?" index={index.current++}>
              ...
              <QuestionAnswer question="Will I be able to receive discounts toward dog grooming tools and equipment as a student or graduate?" index={index.current++}>
              ...
              <QuestionAnswer question="How much can you earn as a professional dog groomer?" index={index.current++}>
        ...
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-12 col-lg-10">
              ...
              <QuestionAnswer question="Is it possible to learn to become a professional dog trainer online?" index={index.current++}>
              ...
              <QuestionAnswer question="Do I need prior training or experience as a dog trainer before taking this course?" index={index.current++}>
              ...
              <QuestionAnswer question="How long will it take to complete my online dog training class?" index={index.current++}>
              ...
              <QuestionAnswer question="What methods do you teach as part of the dog training class?" index={index.current++}>
              ...
              <QuestionAnswer question="Do I need a state or provincial dog training license to work in the industry?" index={index.current++}>
              ...
              <QuestionAnswer question="Will I be able to receive discounts toward dog training tools and equipment as a student or graduate?" index={index.current++}>
              ...
              <QuestionAnswer question="How much can you earn as a professional dog trainer?" index={index.current++}>
