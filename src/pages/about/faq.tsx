            ...
            <div className="col-12 col-lg-10">
              ...
              <Accordion>
                ...
                <QuestionAnswer question="Will I be able to receive discounts toward dog grooming tools and equipment as a student or graduate?" index={i++}>
                  <p className="mb-0">Yes! QC Pet Studies students and graduates are eligible to receive discounts from a variety of pet retailers. For more information, check out this <Link href="/about/student-discounts/"><a className="link text-primary"> full list of preferred dog grooming suppliers.</a></Link>.</p>
                </QuestionAnswer>
            ...
            <div className="col-12 col-lg-10">
              ...
              <Accordion>
                ...
                <QuestionAnswer question="Will I be able to receive discounts toward dog training tools and equipment as a student or graduate?" index={i++}>
                  <p className="mb-0">Yes! QC Pet Studies students and graduates are eligible to receive discounts from a variety of pet retailers. Check out a <Link href=" https://www.doggroomingcourse.com/your-dog-grooming-career/discounts-for-grooming-students/"><a className="link text-primary">full list of preferred suppliers</a></Link> for more info.</p>
                </QuestionAnswer>
