...
export const DDTutorSection: FC<Props> = ({ className, id = 'tutors' }) => {
        ...
        <div className="container text-center">
          <div className="row justify-content-center">
            ...
            <div className="col-12 col-lg-6 align-item-center mb-2">
              <div className="mb-2">
                <Image src={SamanthaMichaelsImage} layout="responsive" placeholder="blur" alt="dog-training expert, Shannon Noonan" />
              </div>
