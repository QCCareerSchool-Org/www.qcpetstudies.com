      ...
      <div className="row align-items-center justify-content-center g-5 g-xl-s">
        ...
        <div className="col-12 col-lg-7">
          ...
          <div className="d-flex gap-3 flex-wrap mt-3">
            {showLink && <Link href="/contact-us" className="btn btn-primary mt-4"><ChatIcon height="22" className="me-2" style={{ position: 'relative', top: -2 }} />Talk to Us Today</Link>}
            {showLink && <Link href="https://calendly.com/qccareerschool/pet" className="btn btn-outline-light mt-4" style={{ borderWidth: '2px' }}><CalIcon height="22" className="me-2" style={{ position: 'relative', top: -3 }} />Book A Call</Link>}
          </div>
        </div>
      </div>
    </div>
