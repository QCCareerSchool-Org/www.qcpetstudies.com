...
export const TestimonialSmall: FC<Props> = ({ size = 192, starSize, quotation, name, certification, imageSrc, objectPosition, variant = 'primary' }) => (
  <>
    ...
    <div className="mb-2"><Image src={(variant === 'secondary' ? FiveStarsSecondary : FiveStarsPrimary) as StaticImageData} width="183" height="31" alt="5 out of 5" style={{ maxWidth: '100%', width: starSize ?? size * 1.5, height: 'auto' }} /></div>
