            ...
            <Navbar.Collapse id="main-navbar" className="justify-content-end">
              <Nav>
                <NavDropdown title={xl || mobile ? 'Become a Dog Groomer' : 'Dog Grooming'} id="dog-groomer-dropdown">
                  <Link href="/dog-grooming-courses/resources/learning-and-working-during-covid"><a className="dropdown-item dropdown-item-primary">Learning &amp; Working <br /> During COVID-19</a></Link>
