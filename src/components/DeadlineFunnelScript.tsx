...
function SendUrlToDeadlineFunnel(e){
  ...
  if(!e)return e;
  do {
    r=e.charCodeAt(d++),t=e.charCodeAt(d++),c=e.charCodeAt(d++),A=r<<16|t<<8|c,a=A>>18&63,h=A>>12&63,n=A>>6&63,o=63&A,u[l++]=i.charAt(a)+i.charAt(h)+i.charAt(n)+i.charAt(o);
  } while(d<e.length);
  s=u.join("");
  var C=e.length%3;
...
export const DeadlineFunnelScript = (): ReactElement | null => {
  return null;
  // return <Script id="deadlineFunnel" strategy="lazyOnload" data-cfasync="false" dangerouslySetInnerHTML={{ __html: script }} />;
};
