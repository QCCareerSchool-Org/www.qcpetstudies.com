...
export const CanadaAuxNavBar: FC = () => {
  ...
  return (
    <AuxNavBar background="red" color="white">
      <div className="d-flex">
        <div className="me-4 d-flex align-items-center"><Image src={MapleLeaf} width={600} height={650} alt="maple leaf" style={{ width: 'auto', height: 24 }} /><strong className="text-uppercase ms-1">Canadian Students Save!</strong></div>
