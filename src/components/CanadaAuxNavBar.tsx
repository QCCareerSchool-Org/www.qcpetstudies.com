  ...
  return (
    <AuxNavBar background="#061F3A" color="white" style={smallerText ? { fontSize: '0.8rem' } : undefined}>
      <div className="d-flex">
        <div className="me-4 d-flex align-items-center"><Image src={MapleLeaf} width={600} height={650} alt="maple leaf" style={{ width: 'auto', height: smallerText ? 14 : 18, position: 'relative', top: smallerText ? 0 : 1 }} /><strong className="text-uppercase ms-1">Canadian Students Save!</strong></div>
