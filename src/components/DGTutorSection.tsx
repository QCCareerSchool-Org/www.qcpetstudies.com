          ...
          <div className="col-12 col-lg-6 d-flex flex-column justify-content-around">
            <div className="d-flex flex-column flex-sm-row align-items-center mb-2 mb-sm-0 mb-lg-4">
              <div className="me-sm-4 mb-1 mb-sm-0">
                <button onClick={lisaPopupToggle} className="btn btn-link"><div className="imageShadowWrapper"><Image
                  src={MasterGroomerLisaImage}
                  alt="Master Groomer Lisa"
                  width="250"
                  height="166"
                  placeholder="blur"
            ...
            <div className="d-flex flex-column flex-sm-row align-items-center">
              <div className="me-sm-4 mb-1 mb-sm-0">
                <button onClick={paddyPopupToggle} className="btn btn-link"><div className="imageShadowWrapper"><Image
                  src={MasterGroomerPaddyImage}
                  alt="Master Groomer Paddy"
                  width="250"
                  height="166"
                  placeholder="blur"
                  style={{ maxWidth: '100%', height: 'auto' }}
