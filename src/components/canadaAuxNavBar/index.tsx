...
export const CanadaAuxNavBar: FC = () => (
  <AuxNavBar background="#061F3A" color="white" className={styles.bar}>
    <div className="d-flex">
      <div className="me-4 d-flex align-items-center"><Image src={MapleLeaf} width={600} height={650} alt="maple leaf" style={{ width: 'auto', height: 14, position: 'relative', top: 0 }} /><strong className="text-uppercase ms-1">Canadian Students Save!</strong></div>
