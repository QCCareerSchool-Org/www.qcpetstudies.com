...
export const CAPriceMessage: FC = () => (
  <div>
    <p className="lead mb-0"><strong><Image src={MapleLeaf as StaticImageData} width={600} height={650} alt="Maple Leaf" style={{ width: 'auto', height: 20 }} /> Canadian Students Save!</strong></p>
